...
type
  TfrmPrincipal = class(TForm)
    ...
    Produto1: TMenuItem;
    Pesquisa1: TMenuItem;
    PesquisarCadastro1: TMenuItem;
    procedure cliente1Click(Sender: TObject);
    procedure Produto1Click(Sender: TObject);
    procedure FormKeyPress(Sender: TObject; var Key: Char);
    procedure PesquisarCadastro1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.PesquisarCadastro1Click(Sender: TObject);
begin
  if not Assigned(frmCadastroProduto) then
    begin
      frmPesquisaCliente := frmPesquisaCliente.Create(Self);
    end;
